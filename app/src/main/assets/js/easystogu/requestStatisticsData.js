...
function loadLuZaoTrendStatistics(version, stockId, dateFrom, dateTo) {
	 ...
	 * @returns {undefined}
	 */
	var url_ind = "http://192.168.1.102:8080/portal/statistics/luzao/trend/"
			+ dateFrom + "_" + dateTo;
	$.getJSON(url_ind, function(data) {
		i = 0;
		for (i; i < data.length; i += 1) {
...
function loadLuZaoGordonStatistics(version, stockId, dateFrom, dateTo) {
	 ...
	 * @returns {undefined}
	 */
	var url_ind = "http://192.168.1.102:8080/portal/statistics/luzao/gordon/"
			+ dateFrom + "_" + dateTo;
	$
			.getJSON(
					url_ind,
...
function loadQsddStatistics(version, stockId, dateFrom, dateTo) {
	 ...
	 */
	/*
	 * var url_ind = "http://192.168.1.102:8080/portal/ind" + version + "/qsdd/" +
	 ...
	 * @returns {undefined}
	 */
	var url_ind = "http://192.168.1.102:8080/portal/statistics/qsdd/" + dateFrom
			+ "_" + dateTo;
	$.getJSON(url_ind, function(data) {
		i = 0;
		for (i; i < data.length; i += 1) {
...
function loadShenXianStatistics(version, stockId, dateFrom, dateTo) {
	 ...
	 * @returns {undefined}
	 */
	var url_ind = "http://192.168.1.102:8080/portal/statistics/shenxian/"
			+ dateFrom + "_" + dateTo;
	$.getJSON(url_ind, function(data) {
		i = 0;
		for (i; i < data.length; i += 1) {
...
function loadMacdStatistics(version, stockId, dateFrom, dateTo) {
	 ...
	 */
	/*
	var url_ind = "http://192.168.1.102:8080/portal/ind" + version + "/macd/"
			+ stockId + "/" + dateFrom + "_" + dateTo;
	$.getJSON(url_ind, function(data) {
		i = 0;
		for (i; i < data.length; i += 1) {
	 ...
	 * @returns {undefined}
	 */
	var url_ind = "http://192.168.1.102:8080/portal/statistics/macd/" + dateFrom
			+ "_" + dateTo;
	$.getJSON(url_ind, function(data) {
		i = 0;
		for (i; i < data.length; i += 1) {
...
function loadWRStatistics(version, stockId, dateFrom, dateTo) {
	 ...
	 */
	/*
	 * var url_ind = "http://192.168.1.102:8080/portal/ind" + version + "/wr/" +
	 * stockId + "/" + dateFrom + "_" + dateTo; $.getJSON(url_ind,
	 * function(data) { i = 0; for (i; i < data.length; i += 1) { var dateStr =
	 * data[i]['date'] + " 15:00:00"; var dateD = new
	 * Date(Date.parse(dateStr.replace(/-/g, "/"))); data_lonTerm.push([
	 ...
	 * @returns {undefined}
	 */
	var url_ind = "http://192.168.1.102:8080/portal/statistics/wr/" + dateFrom
			+ "_" + dateTo;
	$.getJSON(url_ind, function(data) {
		i = 0;
		for (i; i < data.length; i += 1) {
