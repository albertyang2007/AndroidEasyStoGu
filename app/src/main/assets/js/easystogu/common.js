...
function loadCompanyInfo(stockId) {
	var url_company = "http://192.168.1.102:8080/portal/company/" + stockId;
	var companyInfo = "N/A";
...
function loadCompanyInfoByName(name) {
	var url_company = "http://192.168.1.102:8080/portal/company/name=" + name;
	var companyInfo = "N/A";
	$.getJSON(url_company, function(data) {
		companyInfo = data;
	});
...
function loadTrendMode(name) {
	var url_trend = "http://192.168.1.102:8080/portal/trendmode/query/" + name;
	var prices = "[]";
...
function getAllTrendModeNames() {
	var url_names = "http://192.168.1.102:8080/portal/trendmode/listnames";
	var names = "[]";
 ...
 * http://192.168.1.102:8080/query?name=value return value
 */
